...
public interface Server extends com.zeroc.Ice.Object
{
     ...
     **/
    java.util.concurrent.CompletionStage<java.lang.Boolean> isRunningAsync(com.zeroc.Ice.Current current)
     ...
     **/
    java.util.concurrent.CompletionStage<java.lang.Integer> idAsync(com.zeroc.Ice.Current current)
        throws InvalidSecretException;
     ...
     **/
    java.util.concurrent.CompletionStage<java.lang.String> getConfAsync(String key, com.zeroc.Ice.Current current)
        throws InvalidSecretException,
               WriteOnlyException;
     ...
     **/
    java.util.concurrent.CompletionStage<java.util.Map<java.lang.String, java.lang.String>> getAllConfAsync(com.zeroc.Ice.Current current)
        throws InvalidSecretException;
     ...
     **/
    java.util.concurrent.CompletionStage<java.lang.Integer> getLogLenAsync(com.zeroc.Ice.Current current)
        throws InvalidSecretException;
     ...
     * @see getState
     **/
    java.util.concurrent.CompletionStage<java.util.Map<java.lang.Integer, User>> getUsersAsync(com.zeroc.Ice.Current current)
        throws InvalidSecretException,
               ServerBootedException;
     ...
     * @see getChannelState
     **/
    java.util.concurrent.CompletionStage<java.util.Map<java.lang.Integer, Channel>> getChannelsAsync(com.zeroc.Ice.Current current)
        throws InvalidSecretException,
               ServerBootedException;
     ...
     **/
    java.util.concurrent.CompletionStage<java.lang.Boolean> hasPermissionAsync(int session, int channelid, int perm, com.zeroc.Ice.Current current)
        throws InvalidChannelException,
               InvalidSecretException,
               InvalidSessionException,
               ServerBootedException;
     ...
     **/
    java.util.concurrent.CompletionStage<java.lang.Integer> effectivePermissionsAsync(int session, int channelid, com.zeroc.Ice.Current current)
        throws InvalidChannelException,
               InvalidSecretException,
               InvalidSessionException,
               ServerBootedException;
     ...
     **/
    java.util.concurrent.CompletionStage<java.lang.Integer> addChannelAsync(String name, int parent, com.zeroc.Ice.Current current)
        throws InvalidChannelException,
               InvalidSecretException,
               NestingLimitException,
               ServerBootedException;
     ...
     **/
    java.util.concurrent.CompletionStage<Server.GetACLResult> getACLAsync(int channelid, com.zeroc.Ice.Current current)
        throws InvalidChannelException,
               InvalidSecretException,
               ServerBootedException;
     ...
     **/
    java.util.concurrent.CompletionStage<java.util.Map<java.lang.Integer, java.lang.String>> getUserNamesAsync(int[] ids, com.zeroc.Ice.Current current)
        throws InvalidSecretException,
               ServerBootedException;
     ...
     **/
    java.util.concurrent.CompletionStage<java.util.Map<java.lang.String, java.lang.Integer>> getUserIdsAsync(String[] names, com.zeroc.Ice.Current current)
        throws InvalidSecretException,
               ServerBootedException;
     ...
     **/
    java.util.concurrent.CompletionStage<java.lang.Integer> registerUserAsync(java.util.Map<UserInfo, java.lang.String> info, com.zeroc.Ice.Current current)
        throws InvalidSecretException,
     ...
     * @return A completion stage that the servant will complete when the invocation completes.
     **/
    java.util.concurrent.CompletionStage<Void> updateRegistrationAsync(int userid, java.util.Map<UserInfo, java.lang.String> info, com.zeroc.Ice.Current current)
        throws InvalidSecretException,
               InvalidUserException,
               ServerBootedException;
     ...
     **/
    java.util.concurrent.CompletionStage<java.util.Map<UserInfo, java.lang.String>> getRegistrationAsync(int userid, com.zeroc.Ice.Current current)
        throws InvalidSecretException,
               InvalidUserException,
               ServerBootedException;
     ...
     **/
    java.util.concurrent.CompletionStage<java.util.Map<java.lang.Integer, java.lang.String>> getRegisteredUsersAsync(String filter, com.zeroc.Ice.Current current)
        throws InvalidSecretException,
               ServerBootedException;
     ...
     **/
    java.util.concurrent.CompletionStage<java.lang.Integer> verifyPasswordAsync(String name, String pw, com.zeroc.Ice.Current current)
        throws InvalidSecretException,
               ServerBootedException;
     ...
     **/
    java.util.concurrent.CompletionStage<java.lang.Integer> getUptimeAsync(com.zeroc.Ice.Current current)
        throws InvalidSecretException,
               ServerBootedException;
     ...
     **/
    java.util.concurrent.CompletionStage<java.lang.Boolean> isListeningAsync(int userid, int channelid, com.zeroc.Ice.Current current);
    ...
    **/
     ...
     * @throws com.zeroc.Ice.UserException -
    **/
    static java.util.concurrent.CompletionStage<com.zeroc.Ice.OutputStream> _iceD_id(Server obj, final com.zeroc.IceInternal.Incoming inS, com.zeroc.Ice.Current current)
        throws com.zeroc.Ice.UserException
    {
        com.zeroc.Ice.Object._iceCheckMode(com.zeroc.Ice.OperationMode.Idempotent, current.mode);
        inS.readEmptyParams();
     ...
     * @throws com.zeroc.Ice.UserException -
    **/
    static java.util.concurrent.CompletionStage<com.zeroc.Ice.OutputStream> _iceD_addCallback(Server obj, final com.zeroc.IceInternal.Incoming inS, com.zeroc.Ice.Current current)
        throws com.zeroc.Ice.UserException
    {
        com.zeroc.Ice.Object._iceCheckMode(null, current.mode);
     ...
     * @throws com.zeroc.Ice.UserException -
    **/
    static java.util.concurrent.CompletionStage<com.zeroc.Ice.OutputStream> _iceD_removeCallback(Server obj, final com.zeroc.IceInternal.Incoming inS, com.zeroc.Ice.Current current)
        throws com.zeroc.Ice.UserException
    {
        com.zeroc.Ice.Object._iceCheckMode(null, current.mode);
        com.zeroc.Ice.InputStream istr = inS.startReadParams();
     ...
     * @throws com.zeroc.Ice.UserException -
    **/
    static java.util.concurrent.CompletionStage<com.zeroc.Ice.OutputStream> _iceD_setAuthenticator(Server obj, final com.zeroc.IceInternal.Incoming inS, com.zeroc.Ice.Current current)
        throws com.zeroc.Ice.UserException
    {
        com.zeroc.Ice.Object._iceCheckMode(null, current.mode);
        com.zeroc.Ice.InputStream istr = inS.startReadParams();
    ...
    **/
        ...
        throws com.zeroc.Ice.UserException
    {
        com.zeroc.Ice.Object._iceCheckMode(null, current.mode);
        com.zeroc.Ice.InputStream istr = inS.startReadParams();
        java.util.Map<UserInfo, java.lang.String> iceP_info;

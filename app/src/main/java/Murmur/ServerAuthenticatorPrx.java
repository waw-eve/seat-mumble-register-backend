...
public interface ServerAuthenticatorPrx extends com.zeroc.Ice.ObjectPrx
{
     ...
     * @return User id or -2 for unknown name.
     **/
    default java.util.concurrent.CompletableFuture<java.lang.Integer> nameToIdAsync(String name)
    {
     ...
     * @return User id or -2 for unknown name.
     **/
    default java.util.concurrent.CompletableFuture<java.lang.Integer> nameToIdAsync(String name, java.util.Map<String, String> context)
    {
     ...
     * @return -
     **/
    default com.zeroc.IceInternal.OutgoingAsync<java.lang.Integer> _iceI_nameToIdAsync(String iceP_name, java.util.Map<String, String> context, boolean sync)
    {
        com.zeroc.IceInternal.OutgoingAsync<java.lang.Integer> f = new com.zeroc.IceInternal.OutgoingAsync<>(this, "nameToId", com.zeroc.Ice.OperationMode.Idempotent, sync, null);
        f.invoke(true, context, null, ostr -> {
                     ostr.writeString(iceP_name);
                 }, istr -> {
                     int ret;
     ...
     * @return Name of user or empty string for unknown id.
     **/
    default java.util.concurrent.CompletableFuture<java.lang.String> idToNameAsync(int id)
    {
     ...
     * @return Name of user or empty string for unknown id.
     **/
    default java.util.concurrent.CompletableFuture<java.lang.String> idToNameAsync(int id, java.util.Map<String, String> context)
    {
     ...
     * @return -
     **/
    default com.zeroc.IceInternal.OutgoingAsync<java.lang.String> _iceI_idToNameAsync(int iceP_id, java.util.Map<String, String> context, boolean sync)
    {
        com.zeroc.IceInternal.OutgoingAsync<java.lang.String> f = new com.zeroc.IceInternal.OutgoingAsync<>(this, "idToName", com.zeroc.Ice.OperationMode.Idempotent, sync, null);
        f.invoke(true, context, null, ostr -> {
                     ostr.writeInt(iceP_id);
                 }, istr -> {
                     String ret;

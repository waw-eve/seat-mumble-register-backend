...
public interface Meta extends com.zeroc.Ice.Object
{
     ...
     **/
    java.util.concurrent.CompletionStage<java.util.Map<java.lang.String, java.lang.String>> getDefaultConfAsync(com.zeroc.Ice.Current current)
        throws InvalidSecretException;
     ...
     **/
    java.util.concurrent.CompletionStage<Meta.GetVersionResult> getVersionAsync(com.zeroc.Ice.Current current);
     ...
     **/
    java.util.concurrent.CompletionStage<java.lang.String> getSliceAsync(com.zeroc.Ice.Current current);

...
public interface ServerAuthenticator extends com.zeroc.Ice.Object
{
    ...
    public static class GetInfoResult
    {
         ...
         **/
        public GetInfoResult(boolean returnValue, java.util.Map<UserInfo, java.lang.String> info)
        {
            this.returnValue = returnValue;
            this.info = info;
        }
         ...
         **/
        public java.util.Map<UserInfo, java.lang.String> info;
     ...
     **/
    ServerAuthenticator.AuthenticateResult authenticate(String name, String pw, byte[][] certificates, String certhash, boolean certstrong, com.zeroc.Ice.Current current);
     ...
     **/
    ServerAuthenticator.GetInfoResult getInfo(int id, com.zeroc.Ice.Current current);
    ...
    **/
    static java.util.concurrent.CompletionStage<com.zeroc.Ice.OutputStream> _iceD_authenticate(ServerAuthenticator obj, final com.zeroc.IceInternal.Incoming inS, com.zeroc.Ice.Current current)
    {
        ...
        inS.endReadParams();
        ServerAuthenticator.AuthenticateResult ret = obj.authenticate(iceP_name, iceP_pw, iceP_certificates, iceP_certhash, iceP_certstrong, current);
    ...
    **/
    static java.util.concurrent.CompletionStage<com.zeroc.Ice.OutputStream> _iceD_getInfo(ServerAuthenticator obj, final com.zeroc.IceInternal.Incoming inS, com.zeroc.Ice.Current current)
    {
        ...
        inS.endReadParams();
        ServerAuthenticator.GetInfoResult ret = obj.getInfo(iceP_id, current);
        com.zeroc.Ice.OutputStream ostr = inS.startWriteParams();
        ret.write(ostr);
        inS.endWriteParams(ostr);
        return inS.setResult(ostr);

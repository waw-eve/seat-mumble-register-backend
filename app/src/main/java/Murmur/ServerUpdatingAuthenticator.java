...
public interface ServerUpdatingAuthenticator extends ServerAuthenticator
{
     ...
     **/
    int registerUser(java.util.Map<UserInfo, java.lang.String> info, com.zeroc.Ice.Current current);
     ...
     **/
    java.util.Map<java.lang.Integer, java.lang.String> getRegisteredUsers(String filter, com.zeroc.Ice.Current current);
     ...
     **/
    int setInfo(int id, java.util.Map<UserInfo, java.lang.String> info, com.zeroc.Ice.Current current);
    ...
    **/
    static java.util.concurrent.CompletionStage<com.zeroc.Ice.OutputStream> _iceD_getRegisteredUsers(ServerUpdatingAuthenticator obj, final com.zeroc.IceInternal.Incoming inS, com.zeroc.Ice.Current current)
    {
        ...
        inS.endReadParams();
        java.util.Map<java.lang.Integer, java.lang.String> ret = obj.getRegisteredUsers(iceP_filter, current);
        com.zeroc.Ice.OutputStream ostr = inS.startWriteParams();

...
public interface MetaPrx extends com.zeroc.Ice.ObjectPrx
{
    ...
    /** @hidden */
    static final Class<?>[] _iceE_getServer =
    {
    ...
    /** @hidden */
    static final Class<?>[] _iceE_newServer =
    {
        InvalidSecretException.class
    };
        ...
        throws InvalidSecretException
    {
        try
        {
            return _iceI_getBootedServersAsync(context, true).waitForResponseOrUserEx();
        }
        catch(InvalidSecretException ex)
        {
            throw ex;
    ...
    {
        return _iceI_getBootedServersAsync(com.zeroc.Ice.ObjectPrx.noExplicitContext, false);
    }
    ...
    {
        return _iceI_getBootedServersAsync(context, false);
    }
     ...
     * @return -
     **/
    default com.zeroc.IceInternal.OutgoingAsync<ServerPrx[]> _iceI_getBootedServersAsync(java.util.Map<String, String> context, boolean sync)
    {
    ...
    /** @hidden */
    static final Class<?>[] _iceE_getBootedServers =
    {
        InvalidSecretException.class
    };
    ...
    /** @hidden */
    static final Class<?>[] _iceE_getAllServers =
    {
        InvalidSecretException.class
    };
     ...
     **/
    default java.util.Map<java.lang.String, java.lang.String> getDefaultConf()
        throws InvalidSecretException
    {
     ...
     * @return Default configuration of the servers.
     **/
    default java.util.Map<java.lang.String, java.lang.String> getDefaultConf(java.util.Map<String, String> context)
        throws InvalidSecretException
    {
        try
        {
     ...
     * @return Default configuration of the servers.
     **/
    default java.util.concurrent.CompletableFuture<java.util.Map<java.lang.String, java.lang.String>> getDefaultConfAsync()
    {
     ...
     * @return Default configuration of the servers.
     **/
    default java.util.concurrent.CompletableFuture<java.util.Map<java.lang.String, java.lang.String>> getDefaultConfAsync(java.util.Map<String, String> context)
    {
     ...
     * @return -
     **/
    default com.zeroc.IceInternal.OutgoingAsync<java.util.Map<java.lang.String, java.lang.String>> _iceI_getDefaultConfAsync(java.util.Map<String, String> context, boolean sync)
    {
        com.zeroc.IceInternal.OutgoingAsync<java.util.Map<java.lang.String, java.lang.String>> f = new com.zeroc.IceInternal.OutgoingAsync<>(this, "getDefaultConf", com.zeroc.Ice.OperationMode.Idempotent, sync, _iceE_getDefaultConf);
        f.invoke(true, context, null, null, istr -> {
    ...
    /** @hidden */
    static final Class<?>[] _iceE_getDefaultConf =
    {
        InvalidSecretException.class
    };
    ...
    {
        com.zeroc.IceInternal.OutgoingAsync<java.lang.Integer> f = new com.zeroc.IceInternal.OutgoingAsync<>(this, "getUptime", com.zeroc.Ice.OperationMode.Idempotent, sync, null);
        f.invoke(true, context, null, null, istr -> {
                     int ret;
                     ret = istr.readInt();
                     return ret;
     ...
     * @return Contents of the slice file server compiled with.
     **/
    default java.util.concurrent.CompletableFuture<java.lang.String> getSliceAsync()
    {
     ...
     * @return Contents of the slice file server compiled with.
     **/
    default java.util.concurrent.CompletableFuture<java.lang.String> getSliceAsync(java.util.Map<String, String> context)
    {
     ...
     * @return -
     **/
    default com.zeroc.IceInternal.OutgoingAsync<java.lang.String> _iceI_getSliceAsync(java.util.Map<String, String> context, boolean sync)
    {
        com.zeroc.IceInternal.OutgoingAsync<java.lang.String> f = new com.zeroc.IceInternal.OutgoingAsync<>(this, "getSlice", com.zeroc.Ice.OperationMode.Idempotent, sync, null);
        f.invoke(true, context, null, null, istr -> {
                     String ret;
                     ret = istr.readString();
                     return ret;
